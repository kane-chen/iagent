...
public class FinancialAgentTest {

    @Autowired
    private HarnessAgent financialAgent;

    @Test
    public void test_00700() {
        String responseText = doCall("腾讯公司2026Q1的经营活动现金流是多少？为什么增长这么多？web有哪些解释？");
    ...
    private String doCall(String question){
        ...
        Msg response = financialAgent.call(qaMsg).block();
