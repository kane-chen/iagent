...
public class FilingQaTool {
    ...
    private void applyPeriod(FilingQuery.FilingQueryBuilder qb, String fromPeriod, String toPeriod) {
        ParsedPeriod from = parsePeriod(fromPeriod);
        ParsedPeriod to = parsePeriod(toPeriod);
    ...
    public record ParsedPeriod(Integer fiscalYear, String fiscalPeriod) {}
     ...
     * </ul>
     */
    private ParsedPeriod parsePeriod(String text) {
