"""RAGFlow retrieval backend for financial-filing-qa skill.
...
if __name__ == "__main__":
    import sys
    sys.stderr.write(
        "ERROR: _ragflow.py 是 financial-filing-qa skill 的内部 helper 模块，不是 CLI 入口。\n"
        "正确用法：python workspace/skills/financial-filing-qa/scripts/qa.py "
        "--question <Q> --ticker <TICKER> [--backend ragflow]\n"
    )
    sys.exit(2)
